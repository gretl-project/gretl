...
struct gretl_option gretl_opts[] = {
    ...
    { PANPLOT,  OPT_M, "group-means", 0 },
    { PANPLOT,  OPT_O, "groups-overlaid", 0 },
    { PANPLOT,  OPT_S, "group-sequence", 0 },
    { PANPLOT,  OPT_G, "grid", 0 },
    { PANPLOT,  OPT_A, "stacked", 0 },
    { PANPLOT,  OPT_X, "group-boxplots", 0 },
    { PANPLOT,  OPT_B, "boxplot", 0 },
