...
struct gretl_option gretl_opts[] = {
    ...
    { RESET,    OPT_R, "robust", 0 },
    { RESET,    OPT_U, "squares-only", 0 },
    ...
    { STORE,    OPT_R, "gnu-R", 0 },
    { STORE,    OPT_U, "functions", 0 },
    { STORE,    OPT_X, "omit-obs", 0 },
    { STORE,    OPT_Z, "gzipped", 1 },
    { SUMMARY,  OPT_B, "by", 2 },
    { SUMMARY,  OPT_M, "multi", 0 }, /* treat the 1-var case like list */
