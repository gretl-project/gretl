...
enum {
    ...
    P_PRIVATE = 1 <<  5, /* generating a "private" or internal var */
    P_COMPILE = 1 <<  6, /* just compiling tree, not evaluating */
    P_EXEC    = 1 <<  7, /* evaluating pre-built tree */ 
    P_NATEST  = 1 <<  8, /* testing for NAs in expression */
    P_UFRET   = 1 <<  9, /* returning value generated by user function */
    P_QUIET   = 1 << 10, /* don't print any messages or labels */
    P_GETSTR  = 1 << 11, /* state: flag acceptance of plain strings */
