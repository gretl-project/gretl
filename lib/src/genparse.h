...
typedef enum {
    ...
    P_STACK   = 1 << 25, /* executing stack() */
    P_ALTINP  = 1 << 26, /* the input string has been substituted */
    P_OBJQRY  = 1 << 27, /* querying the existence of an object */
    P_STRVEC  = 1 << 28, /* "complex" calc with string-valued series */
