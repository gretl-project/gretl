...
\end{verbatim}
  ...
  multiple \texttt{lfrac} values, as in Section~\ref{sec:simple-search}
...
\end{verbatim}
  ...
  cross validation) as the LASSO or Ridge constraint is progressively
  relaxed. The bundle argument should be obtained via \texttt{regls}
  estimation with multiple \texttt{lfrac} values, as in
