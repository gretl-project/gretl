...
a constant) and a bundle to contain parameters; and it returns a
bundle, described below. Its signature is therefore
\begin{code}
...
\texttt{regls} run (mostly) quietly.
...
\begin{table}[htbp]
  ...
  \end{tabular}
  \caption{Summary of parameters for the \texttt{regls} function: one
    or other of the first two must be always be given}
