...
\item \texttt{B}: The full vector of $k+1$ coefficients, including an
  ...
  \texttt{B} will have just $k$ elements.
...
To obtain out-of-sample pedictions (and/or within-sample fitted values
if you want them), the easiest approach is to use the
\texttt{regls\_pred()} function. FIXME more here.
