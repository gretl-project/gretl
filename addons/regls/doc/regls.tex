...
The one case where \texttt{regls\_pred} and \texttt{mregls\_pred} will
not do the job, is where estimation involved multiple $\lambda$ values
and you want to see predictions based on each value. But that can be
