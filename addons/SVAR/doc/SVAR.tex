...
\label{sec:bundle_struct}
  ...
  \begin{tabular}{rp{0.8\textwidth}}
    ...
    partial, 2 for full\\
    \texttt{boottype}   & scalar, 1 for standard residual resampling, 2 for residual-based 
    wild bootstrap
  \end{tabular}
...
\subsection*{Version 1.5, August 2019}
\begin{itemize}

\item Add the option 'boottype' to choose a wild bootstrap to account for 
heteroskedasticity.
\end{itemize}
