...
\begin{itemize}
\item Fix fatal bug preventing the output of plots with HDsave() and FEVDsave(). 
\end{itemize}
...
\begin{itemize}
\item Start cleaning up and modernizing the internals, and big jump making 2021a the
 required gretl version because of that.
