...
\begin{tabular}{rcl}
  \hline
  \texttt{boottype} & Distribution & Description \\
  \hline
  2 & Gaussian & $w_t \sim N(0,1)$ \\
  3 & Rademacher & $P(w_t = \pm 1) = 0.5$ \\
  4 & Mammen & $w_t = \begin{cases}
...
implies the usual residual resampling.
