...
\label{sec:bundle_struct}
  ...
  \begin{tabular}{rp{0.8\textwidth}}
   ...
   when it is ready}\\
   $\approx$ IRF & bundles or nested array, the IRFs from the accepted draws are actually currently 
   \emph{not} inside the model bundle, see the \texttt{SVAR\_setidIRF} function. This and 
   the datatype of the storage object are subject to change before version 2.0
  \end{tabular}
