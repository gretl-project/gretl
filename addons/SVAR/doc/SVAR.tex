...
could use the existing apparatus in SVAR to pick a certain model. 
...
(FIXME: which is why we need to wrap this into another function....), but here is the solution:

\begin{code}
matrix crosscollect = zeros(mod.SRacc, 1)  
nv = 2
ns = 1
horiz = 1
...
argument 58 instead of the arbitrary 112.
