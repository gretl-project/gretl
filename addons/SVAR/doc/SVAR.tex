...
\subsection*{Version 1.4, January 2019}
\begin{itemize}
...
in SVAR\_setup; catch the case where restrictions would not work (imp2exp) 
and print out a message

\item fixes in the SVEC case especially with further exogenous variables: 
fix indexing error and mis-concatenation, and companion matrix in vecm_est 
with exogenous; 
 
\item internal changes: simplify centered seasonals creation in determ(),
replace isnull with !exists (and vice versa)

\item interface: allow omission of alpha in SVAR\_coint
\end{itemize}
