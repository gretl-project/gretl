...
FIXME: we must integrate this with the IRF plotting functions we
already have, somehow.
...
\subsection{Still to do (for set identification)}

\begin{itemize}
\item proper statistics on accepted/rejected iterations
...
FIXME: add new sign restriction stuff
