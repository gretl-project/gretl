...
Bootstrap results (1024 replications, 0 failed)
             ...
             coefficient    std. error     z       p-value 
  --------------------------------------------------------
  C[ 1; 1]    0.0444250     0.268505      0.1655   0.8686   
  C[ 2; 1]    0.195149      0.0626996     3.112    0.0019    ***
  C[ 1; 2]   -0.802685      0.0812301    -9.882    5.00e-023 ***
  C[ 2; 2]    0.173711      0.0631364     2.751    0.0059    ***

                   coefficient    std. error     z        p-value
  ----------------------------------------------------------------
  LongRun[ 1; 1]    0.446961      0.101229      4.415     1.01e-05 ***
  LongRun[ 2; 1]    0.170568      1.34237       0.1271    0.8989  
  LongRun[ 1; 2]    0.000000      0.000000     -0.02221   0.9823  
  LongRun[ 2; 2]    2.92878       1.03183       2.838     0.0045   ***
\end{scode}
...
\subsection{Version 1.31, January 2018}
\begin{itemize}
...
\item Require gretl version >2016c or >2017a due to internal changes.
