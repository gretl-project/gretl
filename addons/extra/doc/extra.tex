...
\date{December 2022, release 1.6}
...
splitfname, multi\_instrings, fracorder, add\_outofsample:
Sven Schreiber
...
\section{Changelog }
\begin{itemize}
\item December 2022: 1.6, introduce the add\_outofsample function
