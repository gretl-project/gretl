...
% Arguments: \texttt{strings S, string str, bool print\_warnings}
% (optional)

% \noindent Return type: \texttt{matrix}

% Returns the positional entries of a string 'str' in array 'S' in a column
% vector if 'S' contains string 'str', 0 otherwise.

\subsection{onemode}

Arguments: \texttt{matrix v}
...
Arguments: \texttt{bundle b}

\noindent Return type: \texttt{string}
...
(The returned string can then be written to a file; perhaps this function will 
be changed to write the file itself.)
