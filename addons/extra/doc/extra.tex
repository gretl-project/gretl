...
\ArgRet{\texttt{const matrix P}}{matrix} This function finds the
convex hull for a cloud of 2-dimensional points, contained in the
2-column matrix $P$, using the so-called ``Jarvis march'' algorithm.
