...
\ArgRet{\texttt{series x, series y}}{scalar}
...
1-to-n relationship, it returns 1. If there's no relationship, it
returns 0. One of the possible use cases is to check whether two
