...
\ArgRet{\texttt{matrix x}, \texttt{scalar h}}{matrix} This function
...
matrix will have $n \choose k$ rows if successful.
...
\section{Changelog }
\begin{itemize}
\item June 2021: 1.1 (in progress), add combinations
