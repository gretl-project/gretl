...
supports a variety of alternative metrics, and it provides additional
apparatus to visualize the results of clustering, to assess its
effectiveness, and to gauge whether the assumed number of clusters is
appropriate. Plus it offers a graphical interface (see
section~\ref{sec:gui}).
