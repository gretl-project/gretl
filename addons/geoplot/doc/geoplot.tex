...
latitude. However, we offer four options, as follows:
\begin{center}
  \begin{tabular}{cll}
...
There are many websites presenting information on coordinate systems
and map projections. Two of the most useful ones, in our experience,
are:

For reference material: \url{https://spatialreference.org/} \\
For explanation: \url{https://source.opennews.org/articles/choosing-right-map-projection/}
