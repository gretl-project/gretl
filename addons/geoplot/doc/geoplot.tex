...
which contains a color specification comprehensible by gnuplot, or the
keyword \texttt{auto} to confirm automatic color selection. Here's an
example, suitable for a binary payload variable ($k=2$):
\begin{code}
