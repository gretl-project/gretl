...
# Shrink Alaska and place underneath lower 48
matrix shift = {34, -35}
...
per capita across Italian provinces as of 2020-04-27. The appearance
of this plot was tuned using the following option settings:
\begin{code}
...
\begin{figure}[p]
  ...
  \caption{COVID-19 cases per capita by province as of
