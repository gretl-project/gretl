...
payload is \texttt{NA} are omitted, but if you pass a non-zero value
under the key \texttt{keep\_NAs} in the options bundle the outlines of
such regions are shown.
