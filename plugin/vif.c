			...
			const char *fmt, PRN *prn)
{
    ...
    pputs(prn, _("According to BKW, cond >= 30 indicates \"strong\" near linear dependence, and\n"
		 "cond between 10 and 30 \"moderately strong\".  Parameter estimates whose\n"
