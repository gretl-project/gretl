...
static int print_vecm (JVAR *jv, const DATAINFO *pdinfo, PRN *prn)
{
    char s[32];
    double x;
...
static int compute_vecm (JVAR *jv, const DATAINFO *pdinfo, PRN *prn)
{
