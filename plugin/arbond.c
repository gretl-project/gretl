...
/* "secret" public interface for new approach, including
   system GMM: use --system (OPT_L, think "levels") to get
   Blundell-Bond
*/
		    ...
		    gretlopt opt, PRN *prn)
{
    ...
    /* FIXME these deallocations should really be
       handled by dpdinfo_free(), eventually.
    */
