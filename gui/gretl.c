...
GtkItemFactoryEntry data_items[] = {
    ...
    { N_("/Sample/_Set range..."), NULL, set_sample_dialog, SMPL, NULL },
    ...
    { N_("/Sample/_Define, based on dummy..."), NULL, set_sample_dialog, 
      SMPLDUM, NULL },
    ...
    { N_("/Model/Logistic..."), NULL, model_callback, LOGISTIC, NULL },
