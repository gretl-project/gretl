...
GtkItemFactoryEntry data_items[] = {
    ...
    /* structural items */
    { N_("/Data/Dataset structure..."), NULL, data_structure_wizard, 0, NULL },
    { N_("/Data/Compact data..."), NULL, do_compact_data_set, 0, NULL },
    { N_("/Data/Expand data..."), NULL, do_expand_data_set, 0, NULL },
    { N_("/Data/Transpose data..."), NULL, gui_transpose_data, 0, NULL },
    ...
    { N_("/Add/Random variable"), NULL, NULL, 0, "<Branch>" },
    ...
    { N_("/Model/Bivariate tests"), NULL, NULL, 0, "<Branch>" },
    { N_("/Model/Bivariate tests/Difference of means"), NULL, NULL, 0, "<Branch>" },
