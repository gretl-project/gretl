...
GtkItemFactoryEntry data_items[] = {
    ...
    { _("/File/_Open data/import Gnumeric..."), NULL, open_data, 
      OPEN_GNUMERIC, NULL },
    ...
    { _("/Data/Print description"), NULL, print_report, 0, NULL },
    ...
    { _("/Model/Cointe_gration test..."), NULL, selector_callback, COINT, NULL },
