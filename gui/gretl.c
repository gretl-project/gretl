...
GtkItemFactoryEntry data_items[] = {
    ...
    { N_("/File/Browse databases/_RATS 4"), NULL, display_files, 
      RATS_DB, NULL },
    { "/File/Browse databases/sep1", NULL, NULL, 0, "<Separator>" },
    ...
    { N_("/Add/periodic dummies"), NULL, add_dummies, 0, NULL },
    { "/Add/sep3", NULL, NULL, 0, "<Separator>" },
    { N_("/Add/unit dummies"), NULL, add_dummies, 1, NULL },
    { N_("/Add/panel dummies"), NULL, add_dummies, 2, NULL },
    { "/Add/sep4", NULL, NULL, 0, "<Separator>" },
    ...
    { "/Model/sep2a",  NULL, NULL, 0, "<Separator>" },
...
#ifdef ENABLE_GMP
    { N_("/Model/High precision OLS..."), NULL, model_callback, MPOLS, NULL },
#endif
