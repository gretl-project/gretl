...
GtkItemFactoryEntry data_items[] = {
    ...
    { N_("/File/Open data/_User file..."), NULL, open_data, OPEN_DATA, NULL },
    { N_("/File/Open data/_Sample file..."), NULL, display_files, TEXTBOOK_DATA, NULL },
    { "/File/Open data/sep1", NULL, NULL, 0, "<Separator>" },    
    { N_("/File/Open data/_Import"), NULL, NULL, 0, "<Branch>" },
    { N_("/File/Open data/Import/_CSV..."), NULL, open_data, OPEN_CSV, NULL },
    { N_("/File/Open data/Import/_ASCII..."), NULL, open_data, OPEN_ASCII, NULL },
    { N_("/File/Open data/Import/_Octave..."), NULL, open_data, OPEN_OCTAVE, NULL },
    { N_("/File/Open data/Import/_Gnumeric..."), NULL, open_data, OPEN_GNUMERIC, NULL },
    { N_("/File/Open data/Import/_Excel..."), NULL, open_data, OPEN_EXCEL, NULL },
    { N_("/File/Open data/Import/_Eviews..."), NULL, open_data, OPEN_WF1, NULL },
    { N_("/File/Open data/Import/_Stata..."), NULL, open_data, OPEN_DTA, NULL },

    /* File, Append data */
    { N_("/File/_Append data"), NULL, NULL, 0, "<Branch>" },
    { N_("/File/Append data/_Standard format..."), NULL, open_data, APPEND_DATA, NULL },
    { N_("/File/Append data/_CSV..."), NULL, open_data, APPEND_CSV, NULL },
    { N_("/File/Append data/_ASCII..."), NULL, open_data, APPEND_ASCII, NULL },
    { N_("/File/Append data/_Octave..."), NULL, open_data, APPEND_OCTAVE, NULL },
    { N_("/File/Append data/_Gnumeric..."), NULL, open_data, APPEND_GNUMERIC, NULL },
    { N_("/File/Append data/_Excel..."), NULL, open_data, APPEND_EXCEL, NULL },
    { N_("/File/Append data/_Eviews..."), NULL, open_data, APPEND_WF1, NULL },
    { N_("/File/Append data/_Stata..."), NULL, open_data, APPEND_DTA, NULL },
    ...
    { N_("/File/Export data/_Octave..."), NULL, file_save, EXPORT_OCTAVE, NULL },
    ...
    { N_("/File/Script files/_User file..."), NULL, open_script, OPEN_SCRIPT, NULL},
    { N_("/File/Script files/_Practice file..."), NULL, display_files, PS_FILES, NULL}, 
    { N_("/File/Script files/_New script"), NULL, do_new_script, 0, NULL },
    ...
    { N_("/File/_Function files"), NULL, NULL, 0, "<Branch>" },
    { N_("/File/Function files/On _local machine..."), NULL, display_files, FUNC_FILES, 
      NULL },
    { N_("/File/Function files/On _server..."), NULL, display_files, 
      REMOTE_FUNC_FILES, NULL },
    { N_("/File/Function files/_Edit package..."), "", display_files, FUNC_EDIT, NULL },
    { N_("/File/Function files/_New package"), "", file_save, SAVE_FUNCTIONS, NULL },
    ...
    { N_("/Tools/_Sort variables"), NULL, NULL, 0, "<Branch>" },
    { N_("/Tools/Sort variables/By _ID number"), NULL, sort_varlist, 0, NULL },
    { N_("/Tools/Sort variables/By _name"), NULL, sort_varlist, 1, NULL },
    { "/Tools/sep3", NULL, NULL, 0, "<Separator>" },
    { N_("/Tools/_NIST test suite"), NULL, NULL, 0, "<Branch>" },
    { N_("/Tools/NIST test suite/_Basic"), NULL, do_nistcheck, 0, NULL },
    { N_("/Tools/NIST test suite/_Verbose"), NULL, do_nistcheck, 1, NULL },
    { N_("/Tools/NIST test suite/V_ery verbose"), NULL, do_nistcheck, 2, NULL },
    ...
    { N_("/Data/_Add observations..."), NULL, do_add_obs, 0, NULL },
    { N_("/Data/_Remove extra observations"), NULL, do_remove_obs, 0, NULL },
    { "/Data/sep1", NULL, NULL, 0, "<Separator>" },
    /* info items */
    { N_("/Data/_Read info"), NULL, open_info, 0, NULL },
    { N_("/Data/Edit _info"), NULL, edit_header, 0, NULL },
    { N_("/Data/_Print description"), NULL, print_report, 0, NULL },
    ...
    /* structural items */
    { N_("/Data/Dataset _structure..."), NULL, data_structure_wizard, 0, NULL },
    { N_("/Data/_Compact data..."), NULL, do_compact_data_set, 0, NULL },
    { N_("/Data/_Expand data..."), NULL, do_expand_data_set, 0, NULL },
    { N_("/Data/_Transpose data..."), NULL, gui_transpose_data, 0, NULL },

    /* View menu */
    { N_("/_View"), NULL, NULL, 0, "<Branch>" },
    { N_("/View/_Icon view"), NULL, view_session, 0, NULL },
    { "/View/sep0", NULL, NULL, 0, "<Separator>" },
    { N_("/View/_Graph specified vars"), NULL, NULL, 0, "<Branch>" },
    ...
    { N_("/View/_Multiple graphs"), NULL, NULL, 0, "<Branch>" },
    ...
    /* "specials" */
    { N_("/Add/_Index variable"), NULL, add_index, 0, NULL },
    { N_("/Add/_Time trend"), NULL, add_index, 1, NULL },
    { "/Add/sep2", NULL, NULL, 0, "<Separator>" },
    { N_("/Add/_Random variable"), NULL, NULL, 0, "<Branch>" },
    ...
    /* dummies */
    { N_("/Add/_Periodic dummies"), NULL, add_dummies, TS_DUMMIES, NULL },
    { N_("/Add/_Unit dummies"), NULL, add_dummies, PANEL_UNIT_DUMMIES, NULL },
    { N_("/Add/_Time dummies"), NULL, add_dummies, PANEL_TIME_DUMMIES, NULL },
    ...
    { N_("/Variable/_Find..."), NULL, find_var, 0, NULL },
    ...
    { N_("/Variable/_Frequency distribution"), NULL, do_menu_op, 
      FREQ, NULL },
    { N_("/Variable/Frequency _plot"), NULL, NULL, 0, "<Branch>" },
    { N_("/Variable/Frequency plot/_Simple"), NULL, do_freqplot, 0, NULL },
    { N_("/Variable/Frequency plot/Against _Normal"), NULL, do_freqplot, 
      DIST_NORMAL, NULL },
    { N_("/Variable/Frequency plot/Against _Gamma"), NULL, do_freqplot, 
      DIST_GAMMA, NULL },
    { N_("/Variable/Estimated _density plot..."), NULL, do_kernel, 0, NULL },
    { N_("/Variable/_Gini coefficient"), NULL, do_gini, 0, NULL },
    { N_("/Variable/_Range-mean graph"), NULL, do_range_mean, 0, NULL }, 
    { "/Variable/sep1", NULL, NULL, 0, "<Separator>" },
    { N_("/Variable/_Time series plot"), NULL, ts_plot_var, 0, NULL },
    { N_("/Variable/_Correlogram"), NULL, do_corrgm, CORRGM, NULL },
    { N_("/Variable/_Spectrum"), NULL, NULL, 0, "<Branch>" },
    { N_("/Variable/Spectrum/Sample _periodogram"), NULL, do_pergm, 0, NULL }, 
    { N_("/Variable/Spectrum/_Bartlett lag window"), NULL, do_pergm, 1, NULL }, 
...
#ifdef HAVE_X12A
    { N_("/Variable/_X-12-ARIMA analysis"), NULL, do_tramo_x12a, X12A, NULL },
#endif
#ifdef HAVE_TRAMO  
    { N_("/Variable/_TRAMO analysis"), NULL, do_tramo_x12a, TRAMO, NULL }, 
#endif
    { N_("/Variable/_Hurst exponent"), NULL, do_hurst, 0, NULL }, 
    { N_("/Variable/_Runs test"), NULL, do_menu_op, RUNS, NULL }, 
    ...
    { N_("/Model/Other _linear models"), NULL, NULL, 0, "<Branch>" },
    ...
    { N_("/Model/_Time series"), NULL, NULL, 0, "<Branch>" },
    { "/Model/sep2",  NULL, NULL, 0, "<Separator>" },
    { N_("/Model/_Panel"), NULL, NULL, 0, "<Branch>" },
    ...
    { N_("/Model/_Bivariate tests"), NULL, NULL, 0, "<Branch>" },
    { N_("/Model/Bivariate tests/Difference of _means"), NULL, NULL, 0, "<Branch>" },
    ...
    { N_("/Model/_Maximum likelihood..."), NULL, gretl_callback, MLE, NULL },
    { "/Model/sep7",  NULL, NULL, 0, "<Separator>" },
    { N_("/Model/_Simultaneous equations..."), NULL, gretl_callback, SYSTEM, NULL },

    /* Help menu */
    { N_("/_Help"), NULL, NULL, 0, "<LastBranch>" },
    { N_("/Help/_Command reference"), NULL, NULL, 0, "<Branch>" },
    { N_("/Help/Command reference/Plain _text"), NULL, plain_text_cmdref, 0, NULL },
    { N_("/Help/Command reference/_PDF"), NULL, display_pdf_help, 0, NULL },
