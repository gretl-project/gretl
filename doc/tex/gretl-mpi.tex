...
or higher recommended) for MS Windows, macOS, Fedora or Debian-based
Linux distributions. On Linux other then Fedora or Debian you may have
to build gretl yourself.\footnote{To see if the gretl build supplied
  by a distro is MPI-enabled, check for the presence of
...
MPI itself is installed. Here are three variants of the required
command:
\begin{code}
