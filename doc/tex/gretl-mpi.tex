...
while for Macs with M1 processors (``Apple Silicon'') the linkage is
to \textsf{Open MPI} 4.1. To activate MPI support it's necessary to
install the appropriate package, as follows:

\begin{center}
\begin{tabular}{ll}
  Intel & \texttt{openmpi-1.6.5-mac64.tar.xz} \\
  M1 & \texttt{openmpi-4.1-arm64.tar.xz}
\end{tabular}
\end{center}
...
To unpack the package you execute one of the following commands in a
...
# for M1
sudo tar xvf /where/you/put/openmpi-4.1-arm64.tar.xz
\end{code}
%
