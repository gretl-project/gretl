...
denoted by $\statevar$ above (whose corresponding key in the Kalman
bundle is \cmd{statevar}) is assumed to be
$\statevar = R \Sigma_\steta R'$. Note that $\strR$ can have fewer
columns than $r$, thereby making $\statevar$ singular.
