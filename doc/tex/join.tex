...
\textsl{varname} is the name of the series to be imported. Only two
...
match: applying the matching criterion produces exactly one value of
...
Basic syntax: \texttt{join} \textsl{filename} \textsl{varname} [
\textsl{options} ]
