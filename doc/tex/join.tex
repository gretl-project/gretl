...
data). \app{Gretl} provides two more options to the \cmd{join} command
to handle this case swiftly:
\begin{itemize}
\item the \option{tkey} option can be used to indicate which column of
  the outer file contains the outer key, and
\item the \option{time} option specifies the format in which the date
