...
$\sigma^2_v$ is estimated by means of a regression using the
group means of all the relevant variables, that is,
\[
...
containing the $\hat{v}_i$s under the name \dollar{vhat}. This series
