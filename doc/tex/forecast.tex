...
\cmd{fcast} execution. But if you want to create forecast plots within a
...
To be written properly. For the moment, the following simple example
script should hopefully provide the main info. The code
\begin{code}
