...
Matrices can be created using these four approaches:
...
These methods may be combined in the specification of a given matrix.
...
various transformations, just as with the \texttt{genr} command for
scalars and data series.  The relevant mechanisms are discussed in the
