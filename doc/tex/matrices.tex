...
\app{gretl} also offers a quite comprehensive array of matrix
...
\tip{While gretl's built-in statistical functions are capable of
  handling missing values, the matrix arithmetic functions are
  not. When you build a matrix from series that include missing
...
Most \app{gretl} functions apply to matrices as well as series and
