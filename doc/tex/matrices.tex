...
ordering of the elements is column-major for \texttt{lower} but
row-major for \texttt{upper}, as illustrated below for the
$4 \times 4$ case.
\begin{center}
  \begin{tabular}{cccc}
    $d$ & 1 & 2 & 3 \\
  ...
  \end{tabular}
\end{center}
This ensures that \texttt{lower} and \texttt{upper} produce the same
result for a symmetric matrix.
...
elements of the target matrix are set in the order just described; in
