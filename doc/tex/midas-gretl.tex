...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.5]{midas-list-menu}
...
print "=== unrestricted MIDAS (U-MIDAS) ==="
midasreg dy 0 dy(-1) ; mdsl(dXL, 0)
fcast --out-of-sample --static --quiet
FC ~= $fcast

print "=== normalized beta with zero last lag (Beta) ==="
midasreg dy 0 dy(-1) ; mdsl(dXL, 2, {1,5})
fcast --out-of-sample --static --quiet
FC ~= $fcast

print "=== normalized beta, non-zero last lag (BetaNZ) ==="
midasreg dy 0 dy(-1) ; mdsl(dXL, 3, {1,1,0})
fcast --out-of-sample --static --quiet
FC ~= $fcast
...
\begin{figure}[htbp]
  \centering
  \includegraphics{midas_daily_plot}
