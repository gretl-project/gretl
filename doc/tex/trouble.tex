...
(e.g.\ from an \app{xterm} under the X window system, or from a ``DOS
box'' under MS Windows, in which case type \cmd{gretlw32.exe}), rather
than via a desktop menu entry or icon.  Additional error messages may
