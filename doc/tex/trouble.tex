...
\label{trouble-bugs}
      ...
      \app{gretl} (although this statement does
...
\label{trouble-programs}
      ...
      As mentioned above, \app{gretl} calls some
...
\end{center}
      ...
      \app{gretl} issue but rather that the
