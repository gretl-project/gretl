...
On the contrary, suppose that we observe $y_i$, defined as\footnote{We
  ...
  \app{gretl} via a native command yet, but it is possible to estimate
...
a wage equation coupled with a labour force partecipation equation: we
...
next, the generalised residuals are inserted in equation
