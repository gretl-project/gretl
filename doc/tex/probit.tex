...
the most likely outcome of estimation is an error message stating that
the variance-covariance matrix of the parameters is not positive
definite. However, in some cases \app{gretl} may fail to detect the
singularity and report a bogus estimate. This situation, however, is
easily spotted by the fact that in these cases the standard errors
associated with the $\alpha_i$ parameters will be inordinately large.
