...
\cite{gourieroux87}, which can be interpreted as unbiased estimators
...
cross-section for 1987.  For explanations of the matrix methods
employed in the script, see chapter~\ref{chap:matrices}.
