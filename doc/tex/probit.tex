...
hypothesis $\rho = 0$.\footnote{Note that if this estimator is meant
  as a QMLE estimator and the \option{robust} option is used, this
  test may not be valid, even asymptotically.} This can be retrieved
in the form of a bundle named \texttt{independence\_test} under the
\dollar{model} accessor, as in
\begin{code}
