...
(2003)\footnote{Note that the estimates that \app{gretl} gives are
  correct and those found in the printed volume are not: the error is
  acknowledged on the errata web page for the book
