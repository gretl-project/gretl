...
the ratio of the density to the survivor function:\footnote{For a
  fuller discussion see, for example, Davidson and MacKinnon (2004).}
\begin{equation}
...
content of \dollar{yhat}.  For the Weibull the median
is $\exp(X\beta)(\log 2)^\sigma$; for the log-logistic and log-normal
it is just $\exp(X\beta)$.
...
mean and variance both equal to 1 and density $e^{-1}$. See Cameron
and Trivedi (2005) for further discussion.
