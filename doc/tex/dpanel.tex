...
Since \textsf{gretl} version 1.9.2, the primary command for estimating
dynamic panel models has been \texttt{dpanel}. The closely related
...
As in Ox/DPD, the Sargan test statistic reported by \textsf{gretl} is
\[
