...
\cmd{dpanel} command. The script in Table \ref{tab:dpanel-rep}
illustrates use of these matrices to replicate via hansl commands the
calculation of the GMM estimator.

\begin{table}[htbp]
\label{tab:dpanel-rep}
  \begin{scode}
set verbose off
open abdata.gdt
...
print coef
\end{scode}
  \caption{replication of built-in command via hansl commands}
\end{table}
