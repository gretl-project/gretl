...
supported, but whereas \texttt{arbond} only supports the so-called
...
\cite[pp.\ 124--125]{blundell-bond98} for details, but here it suffices
...
used in \cite{CEL96} and \cite{Bond2001}.\footnote{We say an
