...
that the AR tests cannot always be produced when the
\verb|--asymptotic| option is specified in conjunction with one-step
estimation; if you need the tests, either drop the asymptotic flag
or add the \verb|two-step| option.
