...
\begin{tabular}{rp{0.6\textwidth}}
  ...
  \texttt{AR1}, \texttt{AR2} & 1st and 2nd order autocorrelation test
                               statistics \\
  \texttt{sargan}, \dtkttt{sargan_df} & Sargan test for
                                         overidentifying restrictions
                                         and corresponding degrees of
                                         freedom \\
  \texttt{hansen}, \dtkttt{hansen_df} & Hansen test for
                                         overidentifying restrictions
                                         and corresponding degrees of
                                         freedom \\
  \texttt{wald}, \dtkttt{wald_df} & Wald test for
...
Note that \texttt{hansen} and \dtkttt{hansen_df} are not included
