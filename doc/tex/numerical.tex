...
this chapter, we illustrate the tools that \app{gretl} offers for
...
\app{gretl} provides a function, similar to \cmd{fdjac}, for computing
...
The main tools that \app{gretl} offers in this area is integration via
...
In fact, \app{gretl} gives you a ``shorthand'' way to obtain the same
...
\]
in these cases, you can use the syntax \cmd{quadtable(q, 0, m, s)}. So
