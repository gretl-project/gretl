...
A few word of warning are in order: despite its ingenuity, GMM is
...
the eventual output. Among the factors are:
\begin{enumerate}
...
non-trivial reult is virtually impossible to reproduce unless all
