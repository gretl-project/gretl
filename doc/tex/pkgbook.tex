...
For reference, Figure~\ref{fig:local-packages} shows the browser for
installed packages---which we'll be mentioning from time to
time---after \textsf{GHegy} has been installed.
...
\label{fig:local-packages}
  \includegraphics[width=0.8\textwidth]{figures/local-packages.png}
\end{center}
\end{figure}
...
To run \app{make} you need a file, normally called \texttt{Makefile},
