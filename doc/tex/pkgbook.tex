...
\item A text file containing help on the packaged function(s). The
  filename should have suffix \texttt{.md} if you're using gretl's
  markdown option (recommended: see Section~\ref{sec:md} below).
\end{enumerate}
