...
At present there are three spec file entries in this category; in the
GUI package editor they appear under the tabs \textsf{Data files} and
\textsf{Dependencies} in the \textsf{Extra properties} window.
