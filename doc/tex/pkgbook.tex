...
big installs ($>$ 100 MB). And both will take some getting used to for
anyone unfamiliar with unix idioms.
...
confusing, but as of this writing there's a relatively clear account
at \url{http://sourceforge.net/p/mingw-w64/wiki2/MSYS/}. If you select
the ``all-in-one'' package (51 MB zip file), you'll get everything
mentioned in this chapter apart from \textsf{curl} (which is pretty
much an optional extra anyway). \textsf{Curl} can be installed
separately if you want it; see
