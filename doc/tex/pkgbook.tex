...
either by clicking on the ``Info'' icon (top-left), or by
right-clicking on the package entry and selecting \textsf{Info} from
the context menu. You'll be presented with a window like
Figure~\ref{fig:ghegy-info}.
