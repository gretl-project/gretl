...
\begin{itemize}
\item \texttt{list\_no\_singleton} is a boolean, with a default value
...
\item \texttt{list\_no\_const} is also a boolean with a default value
...
\item \texttt{list\_exclude} requires a string value, the name of a
...
These three keywords can also be given in a shorter form, omitting the
\texttt{list\_} prefix, but the more explicit long version is
