...
functionality of \verb|gretl_loadmat| (as for \app{Ox} and
\app{Octave}).
...
\app{gretl} GUI. Neither is there a way of specifying the path to the
\app{stata} executable in the \app{gretl} GUI; the executable must be
in your \texttt{PATH}. Also note that \app{Stata} coerces all variable
