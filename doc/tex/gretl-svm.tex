...
\begin{script}[htbp]
  ...
  \begin{center}
    {\small
    \url{http://ricardo.ecn.wfu.edu/pub/gretl/svm/MS_simple.inp}}
  \end{center}
\begin{scode}
set verbose off
...
list X = dataset
list drop = y folds8 lassofolds holdout
X -= drop
X = cdummify(X)
ntrain = 10000
test1 = ntrain + 1
...
\begin{script}[htbp]
  ...
  \begin{center}
    {\small
    \url{http://ricardo.ecn.wfu.edu/pub/gretl/svm/ca_xvalid.inp}}
  \end{center}
\begin{scode}
set verbose off
open cadata.gdtb -q
...
\begin{script}[p]
  ...
  \label{listing:keane}
    \begin{center}
    {\small
    \url{http://ricardo.ecn.wfu.edu/pub/gretl/svm/multinomial.inp}}
  \end{center}
\begin{scode}
set verbose off
