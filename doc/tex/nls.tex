...
\begin{itemize}
\item Both the actual and predicted relative reductions in the sum of
  squares are at most $\epsilon$.
...
3/4, but it can be adjusted using the \cmd{set} command with the
parameter \verb+nls_toler+.  For example
%
\begin{code}
set nls_toler .0001
\end{code}
