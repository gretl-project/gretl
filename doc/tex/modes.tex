...
possibilities of scripting, take a look at the \app{gretl} Help item
``Script commands syntax,'' or start up the command-line program
\app{gretlcli} and consult its help, or consult the \emph{Gretl
  Command Reference}.
...
menu, ``Graph specified vars'', or via one of \app{gretl}'s other
