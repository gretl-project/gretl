...
this primer---or in the process of doing so---you should take a look
at the following additional resources.
\begin{itemize}
...
\item The \textit{Gretl User's Guide}. Chapters 10 to 16, in
  ...
  discussed here (gretl data types, loops, the definition and use
  of functions). In addition Part II of the \textit{Guide}, on
  Econometric Methods, gives many examples of hansl usage. The
  \textit{Guide} is available via gretl's Help menu; the latest
  version can also be found online at
