...
\texttt{svd}, \texttt{tr}, and \texttt{transp}. Note, however, that
\texttt{mexp} and \texttt{mlog} require that the input matrix be
diagonalizable, and \texttt{cholesky} requires a Hermitian matrix.
