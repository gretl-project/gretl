...
as punctuation in the commands \texttt{printf} and \texttt{sscanf})
then a trailing comma also indicates continuation.  To emphasize the
point: a backslash may be inserted ``arbitrarily'' to indicate
continuation, but a comma works in this capacity only if it is
syntactically valid as part of the command.
