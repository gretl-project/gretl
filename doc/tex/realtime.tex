...
As a result of this operation, the values of the variable in the
\app{gretl} workfile named \texttt{ip\_3rdpub} were published at
...
various auxiliary variables in the \app{gretl} workfile, also using
...
\end{code}
But because we cannot use variables from the \app{gretl} workfile directly
