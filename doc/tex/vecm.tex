...
\begin{script}[htbp]
  \scriptcaption{Estimation of a money demand system with constraints on $\beta$}
...
\begin{script}[htbp]
  \scriptcaption{Further testing of money demand system}
...
\begin{script}[htbp]
  \scriptcaption{Testing for weak exogeneity}
