\chapter{Cointegration and Vector Error
    Correction Models}
...
\item 
	  ...
	  the default for gretl's \cmd{vecm} command.
...
\setlength{\arraycolsep}{.05in}
   ...
   \]
	  ...
	  it may be specified in gretl's \cmd{vecm} command using
