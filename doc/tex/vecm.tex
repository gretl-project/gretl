...
exogenous variables which are assumed to only enter the cointegration
relationships.

Both commands can be given specific options to handle the treatment of
the deterministic component $\mu_t$. These are illustrated in the
following section.
...
make the above expression true: either $\mu_0 = 0$ with $m_z = 0$ or, less
