...
interest rates, $y$ is output and $\pi$ is inflation\footnote{Note
  ...
  prresent context}. Since the contegration rank is 3 and the number
...
824\footnote{There appear to be a few typos in the article.}. Nothe
...
Two such methods are available in \app{gretl}. The default is the
