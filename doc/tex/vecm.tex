...
In this example---from \cite{johansen95}---the cointegration rank is 1
and there are four variables.  However, the model includes a
restricted constant (the \option{rc} flag) so $\beta$ has 5 elements.
