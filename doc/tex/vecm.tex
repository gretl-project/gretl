...
good deal of attention in macroeconometrics over recent years.
The attraction of the Vector Error Correction Model (VECM) is that
it allows the researcher to embed a representation of economic
...
The interpretation of (\ref{eq:VECM}) depends crucially on the rank of
the matrix $\Pi$.
\begin{itemize}
