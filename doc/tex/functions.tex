...
Series, scalar, matrix, bundle and array arguments to functions can be
passed in two ways: ``as they are'', or via pointers. First consider
the following rather artificial example:
\begin{code}
...
\begin{code}
Elapsed time:
without pointers (copy) = 3.3274 seconds,
with pointers (no copy) = 0.00463796 seconds
\end{code}
...
zip archive for distribution. See the \textit{Gretl Function Package
  Guide} for details.
