...
memory --- see previous point); in the first dialog you get to select:
...
Go to ``File, Function files, On local machine''.  You will be
shown a list of the installed packages, including the one you have
just created. If you select it and click on ``Execute'', a window
similar to the one shown in figure \ref{fig:function_call} will appear.
