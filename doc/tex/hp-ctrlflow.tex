...
\tip{At this point some readers may think ``Well, this may be as cool
  as you want, but it's way too complicated for me; I'll just use the
  traditional \cmd{if}''. Of course, there's nothing wrong with that,
  but in some cases the ternary assignment operator can lead to
