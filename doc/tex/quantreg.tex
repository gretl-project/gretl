...
shown below (in this case the \verb|--intervals| option was also
given).
...
As noted above, when you give the \verb|--intervals| option with the
...
use the \verb|--intervals| option, but to compute them using the
