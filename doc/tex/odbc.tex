\chapter{Data import into gretl via ODBC}
\label{chap:odbc}
...
these systems work. What you actually need to do to have \app{gretl}
...
Once the connection is established, the user will send a \emph{query}
...
in an econometric package like \app{gretl} itself: each row is a data
