...
least squares or AR(1) estimators such as Cochrane--Orcutt.  These
depart from the classical linear model, yet according to econometric
tradition standard errors are generally df adjusted.
