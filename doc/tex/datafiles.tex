...
under the ``File, Export data'' menu; in the command-line client use the
...
Begin with \app{gretl}'s ``File, Databases'' menu item. This
...
series into \app{gretl}'s workspace by using the ``Series, Import'' menu item
...
\subsubsection{Changing frequency}
