...
that in the stacking of variable \varname{x1} we wish to read only the
...
signature of the stack function is shown below; the second and third
arguments are optional, defaulting to ``automatic'' and 0
respectively.
\begin{code}
