...
Note that \app{gretl} has a facility for writing out data in the
...
In addition, \app{gretl} offers ODBC connectivity. Be warned: this
feature is meant for somewhat advanced users; there is currently no
GUI interface.  Interested readers will find more info in appendix
\ref{chap:odbc}.
...
columns to a base dataset. In \app{gretl}, the \texttt{join} command
