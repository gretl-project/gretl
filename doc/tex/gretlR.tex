...
As a convenience, you can traffic in matrix files via gretl's
...
\app{R} via gretl, provides a shortcut for the last two lines of
\app{R} code above. The simplied version of the transaction is then
