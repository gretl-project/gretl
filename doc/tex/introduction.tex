...
\item[Cross-platform] \app{gretl}'s home platform is Linux, but it is
  ...
  appropriate basic libraries (see~\ref{app-technote}).
...
thank Ignacio Díaz-Emparanza, Michel Robitaille, Cristian Rigamonti
...
open-source software: for specifics please see~\ref{app-technote}. My
thanks are due to Richard Stallman of the Free Software Foundation,
for his support of free software in general and for agreeing to
``adopt'' \app{gretl} as a GNU program in particular.
...
\end{code}
  ...
  fails, please take a look at~\ref{app-technote}.
