...
\begin{script}[htbp]
  \scriptcaption{ARIMA forecasting}
...
Listing~\ref{arma-lagsel-script}, using annual sunspot data from 1700
...
\begin{script}[htbp]
  \scriptcaption{ARMA lag selection}
  \label{arma-lagsel-script}
\begin{scode}
open sunspots.gdt
