...
\dtkttt{set garch_vcv hessian} & Use the Hessian \\
\dtkttt{set garch_vcv im} & Use the Information Matrix \\
\dtkttt{set garch_vcv op} & Use the Outer Product of the Gradient \\
\dtkttt{set garch_vcv qml} & QML estimator \\
\dtkttt{set garch_vcv bw} & Bollerslev--Wooldridge ``sandwich'' estimator
\end{tabular}
\end{center}
\end{table}
