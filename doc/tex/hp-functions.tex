...
\item the function ends with the \cmd{return} keyword, which exports
  the result;\footnote{Beware: unlike some other languages (e.g.\
    Matlab), you cannot directly return multiple outputs from a
    function. However, you can return a bundle and stuff it with as
