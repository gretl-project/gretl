...
interested reader ought to refer to the ``User-defined
functions'' chapter of the \GUG. Here, we'll just show you a simple,
and hopefully self-explanatory, example which combines features 2 and
3: supposed you have a function for producing smileys, defined as
\begin{code}
