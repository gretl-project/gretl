...
with only a basic knowledge of a Unix system to build \app{gretl}.
...
Then it is necessary to install the development versions of the
libraries that \app{gretl} uses:
...
\app{gretl}, but you'll need the non-development versions to
\emph{run} \app{gretl}; however, most of these should already be part
