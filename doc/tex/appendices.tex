...
zlib (data compression), libxml2 (XML manipulation), LAPACK (linear
algebra support) and FFTW3 (Fast Fourier Transform). The homepage for
...
\href{http://www.netlib.org/lapack/}{netlib.org}; FFTW3 is at
\href{http://www.fftw.org/}{fftw.org}. If the GNU readline
