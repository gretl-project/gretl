...
it using \cmd{print --ten} (see the \emph{Gretl Command Reference}).
...
useful in the creation of additional estimators. It does not, however,
support the creation and manipulation of matrices as such.  If you are
looking for this functionality in the realm of free, open-source
software we recommend taking a look at either GNU R
