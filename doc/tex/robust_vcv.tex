...
proposed by Newey and West (1994); a good concise account of the
method is given in Hall (2005).  This option can be invoked in gretl
via
%
\begin{code}
set hac_lag nw3
...
estimator is not used unless the \verb|--robust| flag is given, or the
