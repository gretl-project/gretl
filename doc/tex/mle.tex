...
This class of models can be effectively dealt with in \app{gretl} by
using the \cmd{frontier} function package. However, a simple version
makes for a non-trivial yet simple illustration of the \cmd{mle}
