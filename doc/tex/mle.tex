...
singular.  Those cases are handled by \app{gretl}'s implementation of
...
to use Newton's method in \app{gretl}.
...
Another feature worth noting is that \app{gretl} does not perform any
...
$\mathbf{g}(\theta)$ as a row vector and then use \ref{sec:fdjac} to
