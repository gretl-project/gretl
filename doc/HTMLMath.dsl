;; Modified from N. Walsh's dbmath.dsl in the html portion of
;; the db stylesheets distribution, version 1.72
;;
;; Allin Cottrell, October 2001
...
(element (equation texmath) (empty-sosofo))
...
(element (informalequation texmath) (empty-sosofo))
...
(element (inlineequation texmath) (empty-sosofo))
