...
Opções:      & \verb|--hilu| (use Hildreth--Lu procedure) \\
...
Opções:      & \verb|--send-data| (pre-load the current dataset) \\
...
\begin{tabular}{ll}
Argumentos:  & \textsl{depvar} \textsl{indepvars} \\
Opção:       & \verb|--vcv| (print covariance matrix) \\
\end{tabular}
...
Opções:      & \verb|--dhansen| (Doornik--Hansen test) \\
