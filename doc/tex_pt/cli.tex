...
\section{Gretl em modo de consola}
\label{cli-console}
...
O \textsl{ficheirodecomandos} é tratado como um argumento de programa; ele
deve especificar um ficheiro para ser usado internamente, usando a sintaxe
\cmd{open ficheirodedados}.  Não esquecer a opção \texttt{-b}
(\textit{batch}=lote), de outro modo o programa ficará a aguardar comandos do
utilizador após a execução da sequência de comandos.
