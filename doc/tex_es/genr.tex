...
En cada caso la función tiene un argumento: el nombre de la variable
a procesar.
...
cíclico, $c_t$, de la serie original.  Si se desea obtener la
...
El uso primario de esta función es la construcción de intervalos de
confianza
...
la
media de $y$ más una muestra obtenida por remuestreo de los residuos
...
usarse con precaución --- no son lo mismlo valores ausentes que
ceros --- pero puede ser útil en algunos contextos. Por ejemplo,
es
...
Para controlar cuál se graba en \verb+$test+ y \verb+$pvalue+ Vd. 
