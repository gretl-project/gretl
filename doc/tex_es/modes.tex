...
ayuda. Una tercera posibilidad es leer el \GCR. 

Además, el paquete \app{gretl} incluye más de 70 lotes de
``ejercicios''. La mayoría de ellos corresponden al libro de
Ramanathan (2002), pero independientemente de ello también pueden
utilizarse como una introducción al modo de escribir lotes de
instrucciones en \app{gretl} así como a varios temas de teoría
econométrica. Se puede acceder a los ejercicios desde ``Archivo, Abrir
archivo de instrucciones, Archivo de prácticas ''. Allí hay un listado
de los ficheros junto con una breve descripción de los puntos que
estos ilustran y los datos que utilizan.  Abra cualquier archivo y
ejecútelo (``Archivo, Ejecutar'' en la ventana de lotes de
instrucciones resultante) para ver los resultados.
...
\item Empezar creando un nuevo archivo de lotes. Teclear cualquier
  ...
  \GCR). Normalmente, este tipo de tareas son más fáciles
...
excepto que el GUI es actualizado basándose en las instrucciones
...
de una pequeña cámara fotográfica en la barra de herramientas.
