...
storiche. Al momento sono disponibili due filtri: il filtro di Hodrick--Prescott
e quello passa banda di Baxter--King.  Sono forniti rispettivamente dalle
funzioni \verb+hpfilt()+ e \verb+bkfilt()+, che richiedono come argomento il
nome della variabile da processare.
