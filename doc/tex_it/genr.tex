...
\left\{
    \begin{array}{c}
      \hat{\theta} \convp \theta \\ 
      \sqrt{n} \left( \hat{\theta} - \theta \right) \convd N(0, \Sigma)
    \end{array}
\right\}
    \Longrightarrow
\left\{
    \begin{array}{c}
      ...
      \sqrt{n} \left( \hat{\psi} - \psi \right) \convd N(0, J
      \Sigma J')
    \end{array}
\right\}
\]
dove $J$ è il Jacobiano $\left.\pder{\psi}{\theta}\right|_{\theta = \hat{\theta}}$.
