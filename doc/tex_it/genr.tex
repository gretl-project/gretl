...
variabili. Il comando è documentato nel \GCR, mentre questo
...
nell'esempio \ref{resample-loop}.  
...
questo modo sono elencate nel \GCR; qui ci occupiamo in particolare
