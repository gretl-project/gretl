...
stima può essere impostata con il comando \cmd{genr}.
...
eseguiti in ogni modalità, se è stata prodotta una soluzione, sono
state confrontate le stime dei parametri ottenute da \app{gretl} con i
valori certificati dal NIST. È stata definita la variabile ``numero
...
hanno prodotto una soluzione; la stessa informazione è fornita per gli
