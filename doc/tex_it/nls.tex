...
elevata alla potenza 3/4, ma può essere modificato usando il comando \cmd{set}
con il parametro \verb+nls_toler+. Ad esempio
%
...
entrambi casi si è usata la tolleranza predefinita.\footnote{I dati
  mostrati nella tabella derivano da una versione di \app{gretl}
  1.0.9, compilata con \app{gcc} 3.3, collegata a \app{glibc} 2.3.2 ed
  eseguita in Linux su un PC i686 (IBM ThinkPad A21m).}
