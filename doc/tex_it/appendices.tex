...
\section{Istruzioni per la compilazione: un esempio}
\label{sec:build-inst}

Questa sezione contiene istruzioni che permettono di compilare \app{gretl}
a un utente con una conoscenza di base di un sistema Unix.
...
A questo punto è possibile iniziare a compilare.
...
\begin{enumerate}
  \item Scaricare il più recente pacchetto dei sorgenti di \app{Gretl}
    ...
    Le versioni rilasciate sotto forma di pacchetto sono testate e possono
    essere compilate senza problemi, ma se si vuole correre qualche rischio,
    è possibile compilare la versione CVS, che contiene modifiche più recenti,
    che saranno incluse nella successiva versione. Le istruzioni per scaricare
    la versione CVS si trovano sull'apposita
