...
possono essere usati per creare nuovi stimatori. Tuttavia, le sue capacità
di scripting e il supporto per la creazione e la manipolazione di matrici
potrebbero non essere all'altezza di problemi computazionali complessi e a larga
scala. Se si cerca software libero che includa queste funzionalità, raccomandiamo
...
\app{Gretl} (se qualcuno ha un'idea migliore per questa operazione, è
pregato di segnalarla).
