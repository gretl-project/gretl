...
Spero che gli utenti con conoscenze di programmazione possano
...
Nell'Ottobre del 2002 ho avuto un utile scambio di idee con Giovanni
Baiocchi e Walter Distaso, che stavano scrivendo una recensione di
\app{gretl} per il \emph{Journal of Applied Econometrics} e con James
MacKinnon, responsabile delle recensioni di software per il
giornale\footnote{La recensione è poi stata pubblicata; si veda
  Baiocchi e Distaso (2003).} e sono grato a Baiocchi e Distaso per il
loro accurato esame del programma, che ha suggerito le seguenti
modifiche.
...
utenti avanzati possono trovare questa lista troppo ristretta.

Senza dubbio, alcuni utenti avanzati preferiranno scrivere da soli il
