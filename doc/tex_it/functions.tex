...
di tre tipi: variabili ordinarie (serie di dati), variabili scalari, o
liste di variabili. Ogni elemento della lista di parametri è composto
da due termini: per prima cosa un indicatore di tipo (\verb+series+,
