...
Ognuno di questi indicatori di tipo, con l'eccezione di \texttt{list},
...
\texttt{X} e di voler calcolare la deviazione standard di ogni variabile della
lista:
%
\begin{code}
loop foreach i X
...
\end{code}
%
Quando una lista è marcata come \texttt{const}, ogni tentativo di rinomiare,
...
una scalare, una serie, una lista o una matrice. Il valore di uscita è specificato
