...
programmazione C. Inoltre, i parametri di tipo \texttt{list} (e solo essi)
possono essere modificati con il tag \texttt{const} (anche in questo caso, 
si veda la sezione \ref{funscope}).
