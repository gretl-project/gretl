...
Quando si esegue lo script, i risultati dei comandi compariranno in
un'unica finestra, dove possono essere modificati, salvati, o copiati negli
appunti. È possibile eseguire uno script facendo clic sull'icone ``Esegui'' o
premendo Ctrl-r. Per conoscere meglio le possibilità fornite dagli script, è possibile
