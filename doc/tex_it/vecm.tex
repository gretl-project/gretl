...
%
dove $m$ è un numero reale e $\varepsilon$$\ensuremath{_{t}}$ è un
processo ``white noise''.  Come si può facilmente mostrare, $x_t$ è un
``random walk'' che fluttua intorno a un trend deterministico con
pendenza $m$. Nel caso particolare in cui $m$ = 0, il trend
deterministico scompare e $x_t$ è un puro random walk.
...
\item Se il VAR include più di due variabili endogene, il rango di
  ...
  comporta che $\mu$\ensuremath{_{0}} sia una combinazione lineare
  delle colonne di $\alpha$.
