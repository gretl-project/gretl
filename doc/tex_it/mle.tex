...
Spesso si sceglie una specificazione lineare per $C_i^*$; ad esempio, la funzione di costo
...
ordinario\footnote{Ancora una volta ricordiamo che gretl contiene il comando
  interno \texttt{probit}, ma in questo caso usiamo il modello probit come
