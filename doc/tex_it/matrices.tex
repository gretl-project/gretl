...
A partire dalla versione 1.5.1, gretl offre la possibilità di creare e manipolare matrici
...
\item Quelle che richiedono come argomento una sola matrice e producono una matrice.
...
restituisce un vettore colonna di lunghezza $n(n+1)/2$ formeato impilando
...
\end{code}
produce la stima a rango ridotto di $A(1)$.
