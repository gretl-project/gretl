...
possibilità di creare \textit{liste personalizzate}.  

\subsection{Creare e modificare liste personalizzate}
...
lunghezza massima del nome è di 31 caratteri. Quando si aggiungono variabili a
...
\subsection{Interrogare le liste}
...
\subsection{Generare liste di variabili trasformate}
