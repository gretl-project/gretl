...
\end{code}
%
È anche possibile usare la parola chiave \texttt{null} al posto di una stringa
per creare una variabile che contiene una stringa nulla. Si veda oltre per altre
varianti del comando string, tra cui l'uso di \texttt{getenv}.
