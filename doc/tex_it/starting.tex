...
\item \textsf{Menù file}
  ...
  \item \textsf{Apri file comandi}: apre un file di comandi di
    \app{gretl} creato dall'utente o uno dei file di esempio forniti
...
\item \textsf{Menù Dati}
  ...
  \item \textsf{Aggiungi osservazioni}: mostra una finestra di dialogo
    ...
    previsioni.
  \item \textsf{Rimuove le osservazioni in più}: attivo solo se
...
\item \textsf{Menù modello}: per i dettagli sui vari stimatori offerti
  da questo menù, si consulti la \GCR\ oppure il capitolo ``Stima'' della
...
\item Avvia una calcolatrice. Una funzione comoda quando si ha bisogno
  ...
  È possibile cambiare il programma nel menù \textsf{File, Preferenze,
