...
fornisce alcune indicazioni per conoscere meglio \TeX e installarlo, se ancora
non lo si ha sul proprio computer. Per chiarezza: \TeX\ non è incluso nella
distribuzione standard di \app{gretl}, è un pacchetto separato, che comprende
vari programmi e file di supporto.
...
È possibile operare su due aree: modificare l'aspetto dell'output prodotto
da \app{gretl} nella modalità di anteprima \LaTeX, e incorporare l'output
di \app{gretl} nei propri file \TeX.

Per quanto riguarda la visualizzazione, è possibile controllare l'aspetto
