...
\section{Gretl e ESL di Ramanathan}
\label{cli-syntax}
...
cambiamenti: le uniche cose a cui prestare attenzione sono i comandi
multilinea e il comando \cmd{freq}.
    
\begin{itemize}
\item In \app{ESL} viene usato un punto e virgola come terminatore per
  molti comandi.  In \app{gretlcli} il carattere punto e virgola è semplicemente
  ignorato, a parte in alcuni casi speciali in cui esso ha un significato
