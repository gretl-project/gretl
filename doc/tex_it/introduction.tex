...
\item[Ragionevolmente sofisticato] \app{Gretl} offre un'ampia varietà
  ...
  di massima verosimiglianza (ad es. logit, probit, tobit) e, dalla versione 1.5.0,
  una funzionalità per la massimizzazione della verosimiglianza generalizzata.
...
La base di codice di \app{Gretl} è derivata dal programma \app{ESL}
...
concesso di distribuire delle versioni \app{Gretl} dei dataset contenuti
...
Rigamonti e Tadeusz e Pawel Kufel, che hanno curato le traduzioni spagnola,
francese, italiana, polacca e tedesca.
...
\app{deb} (per Debian GNU/Linux). Se si preferisce compilare da sé (o si usa un
...
di configurazione si interrompe perché una delle librerie richieste
...
compilare il programma (come descritto sopra), mentre per disabilitare le
funzionalità specifiche di \app{gnome}, occorre usare l'opzione
