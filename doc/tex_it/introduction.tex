...
Schreiber, Talha Yalta e Dirk Eddelbuettel, che cura il pacchetto \app{Gretl}
...
di avere i privilegi di amministratore. Quindi, occorre assumere l'identità
di \texttt{root} prima di eseguire  \texttt{make install}, oppure si può
