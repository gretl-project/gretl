...
A partire dalla versione 1.5.2 di \app{gretl}, i modelli a effetti fissi
...
Questi due metodi (usare le variabili dummy o usare le differenze dalla media)
sono numericamente equivalenti, e \app{gretl} sceglie tra i
...
$m$ è il numero di unità cross-section.
...
(1998). Questi metodi non sono ancora supportati da \app{gretl}, ma il primo
potrebbe essere aggiunto in una delle prossime versioni del programma.
