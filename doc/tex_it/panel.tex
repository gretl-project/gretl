...
\section{Stima OLS pooled}
\label{pooled-est}

Una volta che un dataset è riconosciuto come panel, quando si stima un modello
usando i minimi quadrati ordinari (OLS) è disponibile un tipo di test
aggiuntivo: nel menù \textsf{Test} della finestra del modello è il comando
``Diagnosi panel'', mentre nella versione a riga di comando del programma è
il comando \cmd{hausman}.
