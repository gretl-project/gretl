...
\item File di testo semplice (ASCII). Possono essere importati in
  ...
  tipo di file, si veda la parte\ref{scratch}.
...
\item Cartelle di lavoro in formato \app{MS Excel} o \app{Gnumeric}.
  ...
  dati, Importa''.  La parte\ref{scratch} descrive i requisiti per
  questo tipo di file.
...
\item I valori dei dati devono costituire un blocco rettangolare, con
  ...
  parte~\ref{missing-data}. Il programma si aspetta dati di tipo
...
quello ``tradizionale'') descritti nel capitolo~\ref{datafiles}.
