...
``Dati, Aggiungi variabili'' e/o ``Variabile, Definisci nuova variabile''.
...
dati RATS, occorre usare il comando ``File, Preferenze, Generali...'',
...
``Campione, Struttura Dataset'' nell'interfaccia grafica, o il comando
