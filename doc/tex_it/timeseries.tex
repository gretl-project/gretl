...
La trasformazione più usata in questi casi è la differenziazione, quindi
\app{gretl} fornisce un meccanismo per includere questo passo nel comando
\cmd{arma}: la sintassi
\begin{code}
  arma p d q ; y 
\end{code}
...
calcolati col metodo del prodotto esterno del gradiente (OPG, Outer Product of
Gradient).
