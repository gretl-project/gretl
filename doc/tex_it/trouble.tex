...
l'interfaccia grafica, può essere utile avviare \app{gretl} dal prompt
...
digitare \cmd{gretlw32.exe}), invece che da un menù o da un'icona: la
finestra del terminale potrà quindi contenere messaggi di errore
aggiuntivi.  
