...
GtkItemFactoryEntry data_items[] = {
    ...
    { "/Data/sepsort", NULL, NULL, 0, "<Separator>", GNULL },
    { N_("/Data/Sort variables"), NULL, NULL, 0, "<Branch>", GNULL },
    ...
    { N_("/Data/_Multiple graphs/X-Y scatters..."), 
      NULL, selector_callback, SCATTERS, NULL, GNULL },
    { N_("/Data/_Multiple graphs/line graphs..."), 
    ...
    { N_("/Data/Add variables"), NULL, NULL, 0, "<Branch>", GNULL },
    ...
    { "/Data/Add variables/sep", NULL, NULL, 0, "<Separator>", GNULL },
    ...
    { N_("/Data/Add variables/seed generator..."), NULL, gretl_callback, 
      SETSEED, NULL, GNULL },
    { "/Data/Add variables/sep2", NULL, NULL, 0, "<Separator>", GNULL },
    ...
    { "/Sample/sep2", NULL, NULL, 0, "<Separator>", GNULL },   
    ...
    { "/Sample/sep5", NULL, NULL, 0, "<Separator>", GNULL },
    ...
    { "/Model/sep2a",  NULL, NULL, 0, "<Separator>", GNULL },
