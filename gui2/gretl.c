...
GtkItemFactoryEntry data_items[] = {
    ...
    { N_("/Tools/_Test statistic calculator"), NULL, stats_calculator, CALC_TEST, 
      NULL, GNULL },
    { N_("/Tools/_Probability distributions"), NULL, stats_calculator, CALC_GRAPH, 
      NULL, GNULL },
    ...
    { N_("/View/C_ross-correlogram"), NULL, do_menu_op, XCORRGM, NULL, GNULL },
    ...
    { N_("/Variable/_Frequency distribution"), NULL, do_menu_op, 
      FREQ, NULL, GNULL },
    { N_("/Variable/Frequency _plot"), NULL, NULL, 0, "<Branch>", GNULL },
    { N_("/Variable/Frequency plot/_Simple"), NULL, do_freqplot, 0, NULL, GNULL },
    { N_("/Variable/Frequency plot/Against _Normal"), NULL, do_freqplot, 
      D_NORMAL, NULL, GNULL },
    { N_("/Variable/Frequency plot/Against _Gamma"), NULL, do_freqplot, 
      D_GAMMA, NULL, GNULL },
    ...
    { N_("/Model/_Bivariate tests"), NULL, NULL, 0, "<Branch>", GNULL },
    { N_("/Model/Bivariate tests/Difference of _means"), NULL, NULL, 0, "<Branch>", GNULL },
    { N_("/Model/Bivariate tests/Difference of means/Assuming _equal variances..."), NULL, 
      selector_callback, MEANTEST, NULL, GNULL },
    { N_("/Model/Bivariate tests/Difference of means/Assuming _unequal variances..."), NULL, 
      selector_callback, MEANTEST2, NULL, GNULL },
    { N_("/Model/Bivariate tests/Difference of _variances..."), NULL, selector_callback, 
      VARTEST, NULL,  GNULL },
