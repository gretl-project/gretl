...
GtkActionEntry main_entries[] = {
    ...
    { "TSMulti", NULL, N_("_Multivariate"), NULL, NULL, NULL },
    ...
    { "coint2", NULL, N_("Cointegration test (_Johansen)"), NULL, NULL, G_CALLBACK(selector_callback) },
    { "coint", NULL, N_("Cointegration test (_Engle-Granger)"), NULL, NULL, G_CALLBACK(selector_callback) },
