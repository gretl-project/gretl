...
GtkItemFactoryEntry data_items[] = {
    ...
    { N_("/Add/periodic dummies"), NULL, add_dummies, 0, NULL, GNULL },
    { "/Add/sep3", NULL, NULL, 0, "<Separator>", GNULL },
    { N_("/Add/unit dummies"), NULL, add_dummies, 1, NULL, GNULL },
    { N_("/Add/panel dummies"), NULL, add_dummies, 2, NULL, GNULL },
    { "/Add/sep4", NULL, NULL, 0, "<Separator>", GNULL },
