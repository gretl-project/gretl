...
GtkItemFactoryEntry data_items[] = {
    ...
    /* graphing */
    { N_("/Data/_Graph specified vars"), NULL, NULL, 0, "<Branch>", GNULL },
    ...
    { N_("/Data/_Multiple graphs"), NULL, NULL, 0, "<Branch>", GNULL },
    ...
    { "/Data/sep5", NULL, NULL, 0, "<Separator>", GNULL },
    /* descriptive statistics */
    { N_("/Data/_Summary statistics"), NULL, NULL, 0, "<Branch>", GNULL },
    ...
    { "/Data/sep4", NULL, NULL, 0, "<Separator>", GNULL },
    { N_("/Data/Difference of means"), NULL, NULL, 0, "<Branch>", GNULL },
    ...
    { N_("/Data/Difference of variances..."), NULL, selector_callback, VARTEST, NULL, 
      GNULL },
    { "/Data/sep6", NULL, NULL, 0, "<Separator>", GNULL },
    ...
    { N_("/Sample/Set missing _value code..."), NULL, gretl_callback, 
      GSETMISS, NULL, GNULL },
    { "/Sample/sep4", NULL, NULL, 0, "<Separator>", GNULL },  
    /* structural items */
    ...
    { N_("/Model/Nonlinear/_Logit..."), NULL, model_callback, LOGIT, NULL, GNULL },
    { N_("/Model/Nonlinear/_Probit..."), NULL, model_callback, PROBIT, NULL, GNULL },
    { N_("/Model/Nonlinear/To_bit..."), NULL, model_callback, TOBIT, NULL, GNULL },
    { N_("/Model/Nonlinear/Poi_sson..."), NULL, model_callback, POISSON, NULL, GNULL },
    { N_("/Model/Nonlinear/Lo_gistic..."), NULL, model_callback, LOGISTIC, NULL, GNULL },
    { N_("/Model/Nonlinear/Nonlinear Least Squares..."), NULL, gretl_callback, NLS, NULL, GNULL },
