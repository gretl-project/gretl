...
/* new GTK UI Manager stuff -- not ready yet */
...
GtkActionEntry main_entries[] = {
    ...
    { "OpenSampleData", GTK_STOCK_OPEN, N_("_Sample file..."), "", NULL, G_CALLBACK(open_data) },
    ...
    { "SaveAsGdt", NULL, N_("_Standard format..."), NULL, NULL, G_CALLBACK(file_save) },
    { "SaveAsDb",  NULL, N_("_Database..."), NULL, NULL, G_CALLBACK(file_save) },

    { "ExportData", NULL, N_("_Export data"), NULL, NULL, NULL },
    { "ExportCSV",    NULL, N_("_CSV..."), NULL, NULL, G_CALLBACK(file_save) },
    { "ExportR",      NULL, N_("GNU _R..."), NULL, NULL, G_CALLBACK(file_save) },
    { "ExportOctave", NULL, N_("_Octave..."), NULL, NULL, G_CALLBACK(file_save) },
    { "ExportJMulTi", NULL, N_("_JMulTi..."), NULL, NULL, G_CALLBACK(file_save) },
    { "ExportPcGive", NULL, N_("_PcGive..."), NULL, NULL, G_CALLBACK(file_save) },
    ...
    { "OpenUserScript", NULL, N_("_User file..."), NULL, NULL, G_CALLBACK(open_script) },
    { "OpenSampleScript", NULL, N_("_Practice file..."), NULL, NULL, G_CALLBACK(display_files) },
    { "NewScript", NULL, N_("_New script"), NULL, NULL, NULL },
    { "NewGretlScript", NULL, N_("gretl_script"), NULL, NULL, G_CALLBACK(do_new_script) },
    { "NewGnuplotScript", NULL, N_("gnuplot_script"), NULL, NULL, G_CALLBACK(do_new_script) },
    { "NewRScript", NULL, N_("R script"), NULL, NULL, G_CALLBACK(do_new_script) },

    { "SessionFiles", NULL, N_("_Session files"), NULL, NULL, NULL },
    { "OpenSession", GTK_STOCK_OPEN, N_("_Open session..."), NULL, NULL, G_CALLBACK(open_script) },
    { "SaveSession", GTK_STOCK_SAVE, N_("_Save session"), NULL, NULL, 
    ...
    { "NativeDB", GTK_STOCK_OPEN, N_("_Gretl native..."), NULL, NULL, G_CALLBACK(display_files) },
    { "RATSDB", GTK_STOCK_OPEN, N_("_RATS 4..."), NULL, NULL, G_CALLBACK(open_data) },
    { "PcGiveDB", GTK_STOCK_OPEN, N_("_PcGive..."), NULL, NULL, G_CALLBACK(open_data) },
    { "RemoteDB", GTK_STOCK_NETWORK, N_("On database _server..."), NULL, NULL, G_CALLBACK(display_files) },

    { "FunctionFiles", NULL, N_("_Function files"), NULL, NULL, NULL },
    { "LocalGfn", GTK_STOCK_OPEN, N_("On _local machine..."), NULL, NULL, G_CALLBACK(display_files) },
    { "RemoteGfn", GTK_STOCK_NETWORK, N_("On _server..."), NULL, NULL, G_CALLBACK(display_files) },
    { "NewGfn", GTK_STOCK_NEW, N_("_New package"), NULL, NULL, G_CALLBACK(new_function_pkg_callback) },
    ...
    { "PrefsFixedFont", GTK_STOCK_SELECT_FONT, N_("_Fixed font..."), NULL, NULL, 
      G_CALLBACK(font_selector) },
#if !defined(USE_GNOME)
    { "PrefsMenuFont", GTK_STOCK_SELECT_FONT, N_("_Menu font..."), NULL, NULL, 
      G_CALLBACK(font_selector) },
#endif

    /* Data */
    { "DataMenu", NULL, N_("_Data"), NULL, NULL, NULL },
    ...
    { "DataStructure", NULL, N_("Dataset _structure..."), NULL, NULL, G_CALLBACK(data_structure_wizard) },
    ...
    { "BoxPlot", NULL, N_("_Boxplots..."), NULL, NULL, G_CALLBACK(gretl_callback) },
    { "NotchedBox", NULL, N_("_Notched boxplots..."), NULL, NULL, G_CALLBACK(gretl_callback) },
    ...
    { "SummaryStats", NULL, N_("_Summary statistics"), NULL, NULL, G_CALLBACK(do_menu_op) },
    { "CorrMatrix", NULL, N_("_Correlation matrix"), NULL, NULL, G_CALLBACK(do_menu_op) },
    { "CrossTab", NULL, N_("Cross _Tabulation"), NULL, NULL, G_CALLBACK(do_menu_op) },
    { "PrinComp", NULL, N_("_Principal components"), NULL, NULL, G_CALLBACK(do_menu_op) },
    { "MahalDist", NULL, N_("_Mahalanobis distances"), NULL, NULL, G_CALLBACK(do_menu_op) },
    { "CrossCorrgm", NULL, N_("C_ross-correlogram"), NULL, NULL, G_CALLBACK(xcorrgm_callback) },

    /* Add */
    { "AddMenu", NULL, N_("_Add"), NULL, NULL, NULL },
    ...
    { "DIFFS", NULL, N_("_First differences of selected variables"), NULL, NULL, 
      G_CALLBACK(add_logs_etc) },
    { "LDIFFS", NULL, N_("_Log differences of selected variables"), NULL, NULL, 
      G_CALLBACK(add_logs_etc) },
    { "SDIFFS", NULL, N_("_Seasonal differences of selected variables"), NULL, NULL, 
      G_CALLBACK(add_logs_etc) },
    ...
    { "AddPeriodDums", NULL, N_("_Periodic dummies"), NULL, NULL, G_CALLBACK(add_dummies) },
    { "AddUnitDums", NULL, N_("_Unit dummies"), NULL, NULL, G_CALLBACK(add_dummies) },
    { "AddTimeDums", NULL, N_("_Time dummies"), NULL, NULL, G_CALLBACK(add_dummies) },
    { "AddDiscreteDums", NULL, N_("Dummies for selected _discrete variables"), NULL, NULL, 
      G_CALLBACK(add_logs_etc) },
    { "DefineVar", NULL, N_("Define _new variable..."), NULL, NULL, G_CALLBACK(gretl_callback) },
    { "DefineMatrix", NULL, N_("_Define matrix..."), NULL, NULL, G_CALLBACK(matrix_edit_callback) },

    /* Sample */
    { "SampleMenu", NULL, N_("_Sample"), NULL, NULL, NULL },
    { "SetRange", NULL, N_("_Set range..."), NULL, NULL, G_CALLBACK(sample_range_dialog) },
    { "FullRange", NULL, N_("_Restore full range"), NULL, NULL, G_CALLBACK(restore_sample_callback) },
    { "SampleDummy", NULL, N_("_Define, based on dummy..."), NULL, NULL, G_CALLBACK(sample_range_dialog) },
    { "SampleRestrict", NULL, N_("_Restrict, based on criterion..."), NULL, NULL, 
      G_CALLBACK(gretl_callback) },
    { "SampleRandom", NULL, N_("R_andom sub-sample..."), NULL, NULL, G_CALLBACK(sample_range_dialog) },
    ...
    { "SetMissing", NULL, N_("Set missing _value code..."), NULL, NULL, G_CALLBACK(gretl_callback) },

    /* Variable */
    { "VariableMenu", NULL, N_("_Variable"), NULL, NULL, NULL },
    { "VarFind", GTK_STOCK_FIND, N_("_Find..."), NULL, NULL, G_CALLBACK(find_var) },
    { "VarDisplay", NULL, N_("_Display values"), NULL, NULL, G_CALLBACK(display_var) },
    { "VarSummary", NULL, N_("_Summary statistics"), NULL, NULL, G_CALLBACK(do_menu_op) },
    { "VarNormTest", NULL, N_("_Normality test"), NULL, NULL, G_CALLBACK(do_menu_op) },
    { "VarFreqDist", NULL, N_("_Frequency distribution"), NULL, NULL, G_CALLBACK(do_freq_dist) },
    { "VarFreqPlot", NULL, N_("Frequency _plot"), NULL, NULL, G_CALLBACK(do_freq_dist) },
    { "VarDensity", NULL, N_("Estimated _density plot..."), NULL, NULL, G_CALLBACK(do_kernel) },
    { "VarGini", NULL, N_("_Gini coefficient"), NULL, NULL, G_CALLBACK(do_gini) },
    { "RangeMeanPlot", NULL, N_("_Range-mean graph"), NULL, NULL, G_CALLBACK(do_range_mean) },
    { "VarTSPlot", NULL, N_("_Time series plot"), NULL, NULL, G_CALLBACK(ts_plot_var) },
    { "VarCorrgm", NULL, N_("_Correlogram"), NULL, NULL, G_CALLBACK(do_corrgm) },
    { "Spectrum", NULL, N_("_Spectrum"), NULL, NULL, NULL },
    { "VarPergm", NULL, N_("Sample _periodogram"), NULL, NULL, G_CALLBACK(do_pergm) },
    { "VarBartlett", NULL, N_("_Bartlett lag window"), NULL, NULL, G_CALLBACK(do_pergm) },
    { "ADF", NULL, N_("_Augmented Dickey-Fuller test"), NULL, NULL, G_CALLBACK(unit_root_test) },
    { "ADF-GLS", NULL, N_("ADF-GLS"), NULL, NULL, G_CALLBACK(unit_root_test) },
    { "KPSS", NULL, N_("_KPSS test"), NULL, NULL, G_CALLBACK(unit_root_test) },
    { "Filter", NULL, N_("_Filter"), NULL, NULL, NULL },
    { "FilterMA", NULL, N_("_Simple moving average"), NULL, NULL, G_CALLBACK(filter_callback) },
...
#ifdef HAVE_X12A
    { "VarX12A", NULL, N_("_X-12-ARIMA analysis"), NULL, NULL, G_CALLBACK(do_tramo_x12a) },    
#endif
#ifdef HAVE_TRAMO
    { "VarTramo", NULL, N_("_TRAMO analysis"), NULL, NULL, G_CALLBACK(do_tramo_x12a) },  
#endif
    { "VarHurst", NULL, N_("_Hurst exponent"), NULL, NULL, G_CALLBACK(do_hurst) },     
    { "VarEditAttrs", NULL, N_("_Edit attributes"), NULL, NULL, G_CALLBACK(varinfo_callback) },     
    { "VarSetMissing", NULL, N_("Set missing _value code..."), NULL, NULL, G_CALLBACK(gretl_callback) },     
    { "VarNew", NULL, N_("Define _new variable..."), NULL, NULL, G_CALLBACK(gretl_callback) }, 

    /* Model */
    { "ModelMenu", NULL, N_("_Model"), NULL, NULL, NULL },
    ...
    { "UserGuide", NULL, N_("_User's guide"), NULL, NULL, G_CALLBACK(display_pdf_help) },
    { "UpdateCheck", GTK_STOCK_NETWORK, N_("Check for _updates"), NULL, NULL, 
      G_CALLBACK(manual_update_query) },
#if GTK_MINOR_VERSION >= 6
...
static void set_up_main_menu (void)
{
    ...
    GtkUIManager *ui;
    GError *error = NULL;
    gint n_entries = sizeof main_entries / sizeof main_entries[0];

    actions = gtk_action_group_new("Actions");
    gtk_action_group_add_actions(actions, main_entries, n_entries, NULL);
    ...
    if (!gtk_ui_manager_add_ui_from_file(ui, "gretlmain.xml", &error)) {
	g_message("building menus failed: %s", error->message);
	g_error_free(error);
    } else {
	add_conditional_items(ui);
    }

    mdata->mbar = gtk_ui_manager_get_widget(ui, "/MenuBar");
}
